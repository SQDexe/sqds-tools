...
/// Can be interpreted as a `ternary operator`.  
/// 
/// This macro expands into a `match` on a bool. 
/// 
/// # Examples
/// 
/// ```rust
...
/// Custom, batch assertion on a number of expresions.
/// 
...
/// Decleares body of a trait for a bunch of types.
/// 
/// Useful for adding traits for mutiple types, when using generics is cumbersome, or outright impossible.
/// 
/// # Examples
/// 
/// ```rust
...
/// impl_trait! {
///     BitsSize,
///     { const CUSTOM_BITS: usize = Self::BYTES * 8; },
///     u8, u16, u32, u64
///     }
/// 
/// /* Check whether it's correct */
